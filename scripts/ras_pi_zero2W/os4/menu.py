...
class Menu:
    def __init__(self, screen,draw0,draw1,draw2,draw3,molette,button,camera):
        self.screen = screen
        self.draw0 = draw0
        self.draw1=draw1
        self.draw2=draw2
        ...
        self.adv_opt=['W R I T I N G   F P S ','R E C O R D I N G   F P S ', 'B A C K ']
    ...
    def menu_4(self):
        self.draw3.clear_img()
        for i in range(len(self.adv_opt)):
            self.draw3.draw_msg(self.adv_opt[i],(80,(i+1)*30))
            
        
    
    def control_menu_4(self):
        pass
